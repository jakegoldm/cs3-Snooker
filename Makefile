...
DEMOS = game # bounce gravity pacman nbodies damping damping2 spaceinvaders pegs breakout
...
STUDENT_LIBS = vector list polygon color body scene forces shape collision game_state menu_state sound_set
